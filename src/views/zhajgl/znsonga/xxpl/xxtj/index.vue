      ...
      <div class="filter-container">
        <el-form class="base-search-form" :model="form" :inline="true">
          ...
          <div class="one">
            ...
            <span class="span-item" @click="baocun">保存成草稿</span>
            <span class="span-item" @click="send">发布</span>
...
export default {
  ...
  methods: {
    ...
    yulan() {
      ...
      this.$message.success('恭喜预览成功, 您可进行保存或发布操作')
    },
    baocun() {
      if (!this.yulanShow) {
    ...
    clickOne() {
      this.daiding = this.daiding + this.$refs.imgone.innerHTML
    },
    mainChart() {
